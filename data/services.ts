...
export const services: Services = {
  ...
  items: [
    ...
    },
    {
        ...
        description: "Modern React and Next.js applications tailored to your business.",
    ...
    },
    {
        ...
        description: "Business systems that automate processes and improve efficiency.",
        icon: "building2",
        stack: [
            { name: "Microservices" },
            { name: "Sacalable APIs" },
    ...
    },
    {
        ...
        description: "Fast, responsive, and accessible user interfaces built with React.",
        icon: "layoutTemplate",
        stack: [
            { name: "React" },
            { name: "Next.js" },
    ...
    },
    {
        ...
        description: "Architecture reviews, technical guidance, and solution planning.",
        icon: "lightBulb",
        stack: [
            { name: "System Design" },
            { name: "Scalability" },
